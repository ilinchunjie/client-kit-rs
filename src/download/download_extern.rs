...
#[no_mangle]
pub extern "C" fn add_downloader(ptr: *mut DownloadService, config: DownloadConfig) -> *mut FFIDownloadOperation {
...
#[no_mangle]
pub extern "C" fn get_download_error(ptr: *mut DownloadOperation) -> *mut FFIString {
    let operation = unsafe { ptr.as_mut().expect("invalid ptr: ") };
